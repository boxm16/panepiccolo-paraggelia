...
<html lang="en">
    <head>
        ...
        <title>My Last Order Page</title>
        ...
        <div class="container">
            ...
            <div class='col-sm'>
                <div class="table-responsive">
                    ...
                    <h1>${customer.username}'s My Last Order Page</h1>
                            ...
                            <table id="table" border="5" class="table">
                                ...
                                <c:forEach items="${order.orderItems}" var="current" varStatus="loop">
                                    <tr class="row1">
                                        ...
                                        <td><input type="number" name="orderItems[${loop.index}].quantity" tabindex="${loop.index}"  value="${current.quantity}" onchange="colorChange(this)" class="quantity" style="width: 4em"></td>
