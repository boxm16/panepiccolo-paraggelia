                                ...
                                <c:forEach items="${products}" var="cur" >
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger"  onclick="location.href = '${pageContext.request.contextPath}/deleteProduct.htm?product_id=${cur.product_id}'" >ΔΙΑΓΡΑΦΗ ΠΡΟΙΝΟΝΤΟΣ</button>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
