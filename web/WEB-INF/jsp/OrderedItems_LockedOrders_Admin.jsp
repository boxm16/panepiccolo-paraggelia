                        ...
                        <table id="table" class="table-hover " border="5">
                            ...
                            <c:forEach items="${OrderedItemsBakingUnitSummary_LockedOrders}" var="current" varStatus="loop">
                                <tr >
                                    ...
                                    <td><button  class="btn btn-success" onclick="location.href = '${pageContext.request.contextPath}/ProductOrderers_LockedOrders.htm?product_id=${current.product.product_id}'">ΔΕΣ ΑΝΑΛΥΤΙΚΑ</button></td>
