...
<html lang="en">
    <head>
        ...
        <title>ΕΝΕΡΓΕΣ ΠΑΡΑΓΓΕΛΙΕΣ STAFF</title>
            ...
            <div class="row">
                <div class="col-sm">
                    ...
                    <nav class="nav flex-column nav-pills" style="background:lightskyblue;" >
                        <a class="nav-link " href="${pageContext.request.contextPath}/ObserverPage_LockedOrders.htm"">ΔΕΣ ΚΛΕΙΔΩΜΕΝΕΣ ΠΑΡΑΓΓΕΛΙΕΣ</a>
                    ...
                    <div class="table-responsive">
                        ...
                        <h3>ΕΝΕΡΓΕΣ ΠΑΡΑΓΓΕΛΙΕΣ STAFF</h3>

                        <hr>

                        <ul class="list-group">

                            <c:forEach items="${filledCustomersList_ActiveOrders}" var="current" varStatus="loop">
                                <li >
